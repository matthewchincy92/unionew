 ...
 *
 *   // network
 *   CUnioNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.unio.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUnioNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: UnioNetwork
// //   -- signature requirements : Key1(User)
// class CUnioNetworkVariable : public CGovernanceObject
// {
// private:

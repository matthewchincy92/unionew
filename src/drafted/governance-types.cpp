...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "UnioNetwork") type = UnioNetwork;
    if(strType == "UnioNetworkVariable") type = UnioNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == UnioNetwork) s = "UnioNetwork";
    if(type == UnioNetworkVariable) s = "UnioNetworkVariable";

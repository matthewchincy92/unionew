    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Unio Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Unio Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  unio-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Unio in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 UNIO, 0.1 UNIO, 1 UNIO and 10 UNIO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://uniocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://uniocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Unio Core is shutting down...") + "<br /><br />" +

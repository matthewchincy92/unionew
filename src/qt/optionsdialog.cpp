    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("UNIO-light"), QVariant("light"));
    ui->theme->addItem(QString("UNIO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("UNIO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("UNIO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("UNIO-traditional"), QVariant("trad"));

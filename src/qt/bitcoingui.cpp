    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Unio Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Unio address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unio: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Unio Core"), this);
    aboutAction->setStatusTip(tr("Show information about Unio Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Unio Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Unio addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Unio addresses"));
    ...
    openAction->setStatusTip(tr("Open a unio: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Unio Core help message to get a list with possible Unio Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Unio Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Unio network", "", count));
    } else {
...
{
    QString strTitle = tr("Unio Core"); // default title

...
This mechanism has been integrated into Bitcore-Node-Unio which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/uniocoin/insight-api-unio#web-socket-api](https://github.com/uniocoin/insight-api-unio#web-socket-api)
* API: [https://github.com/uniocoin/insight-api-unio#instantsend-transactions](https://github.com/uniocoin/insight-api-unio#instantsend-transactions)
...
By default, the Unio Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Unio Core daemon:

...
Unio Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9838.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9338 for connections and services them.
...
However, in open source software such as Unio Core, where everyone uses
...
pay attention to for reviewers of Unio Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Unio Core uses tinyformat, which is type safe. Leave them out to avoid confusion
